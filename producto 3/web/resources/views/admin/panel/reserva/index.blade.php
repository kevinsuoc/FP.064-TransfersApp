...
<div class = "main-container">
    ...
    <div>
            ...
            <p><strong>Vehículo: </strong>{{ $reserva->vehiculo->descripcion }}</p>
            <p><strong>Email conductor: </strong>{{ $reserva->vehiculo->email_conductor }}</p>
            <!-- <P><strong>Precio: </strong></P> -->

            @if ($reserva->id_tipo_reserva == 1 || $reserva->id_tipo_reserva == 3)
            <p>Datos de ida</p>
            <p><strong>Hotel de destino: </strong>{{$reserva->destino->usuario}}</p>
            ...
            <p><strong>Aeropuerto de origen: </strong>{{$reserva->aeropuerto_origen}}</p>
            @elseif ($reserva->id_tipo_reserva == 2 || $reserva->id_tipo_reserva == 3)
            <p>Datos de vuelta</p>
            <p><strong>Hotel de origen: </strong>{{$reserva->origen->usuario}}</p>
